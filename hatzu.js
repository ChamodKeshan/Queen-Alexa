...
module.exports = {
    ...
    PLAYS: process.env.PLAYS === undefined ?'https://api.dapuhy.xyz/api/search/playstore?query=game+burik&apikey=beta' : process.env.PLAYS,
    PLAYI: process.env.PLAYI === undefined ?'https://api.dapuhy.xyz/api/search/playstore-info?id=com.mobile.legends&apikey=beta' : process.env.PLAYI,
